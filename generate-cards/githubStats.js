...
<g class="stat-row" style="animation-delay: 0ms" transform="translate(20, 50)">
  <svg class="icon" width="16" height="16" viewBox="0 0 16 16" y="-12">
  ...
  <text x="22" y="0">
    ...
    <tspan x="330" class="stat-value">${stats.stars}</tspan>
  </text>
</g>

<!-- Forks -->
<g class="stat-row" style="animation-delay: 150ms" transform="translate(20, 80)">
  <svg class="icon" width="16" height="16" viewBox="0 0 16 16" y="-12">
    <path fill-rule="evenodd" d="M5 3.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm0 2.122a2.25 2.25 0 10-1.5 0v.878A2.25 2.25 0 005.75 8.5h1.5v2.128a2.251 2.251 0 101.5 0V8.5h1.5a2.25 2.25 0 002.25-2.25v-.878a2.25 2.25 0 10-1.5 0v.878a.75.75 0 01-.75.75h-4.5A.75.75 0 015 6.25v-.878zm3.75 7.378a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm3-8.75a.75.75 0 100-1.5.75.75 0 000 1.5z"></path>
  </svg>
  <text x="22" y="0">
    <tspan class="stat-label">Forks</tspan>
    <tspan x="330" class="stat-value">${stats.forks}</tspan>
  </text>
</g>

<!-- Contributions -->
<g class="stat-row" style="animation-delay: 300ms" transform="translate(20, 110)">
  <svg class="icon" width="16" height="16" viewBox="0 0 16 16" y="-12">
  ...
  <text x="22" y="0">
    ...
    <tspan x="330" class="stat-value">${stats.contributions}</tspan>
  </text>
</g>

<!-- Lines changed -->
<g class="stat-row" style="animation-delay: 450ms" transform="translate(20, 140)">
  <svg class="icon" width="16" height="16" viewBox="0 0 16 16" y="-12">
  ...
  <text x="22" y="0">
    ...
    <tspan x="330" class="stat-value">${stats.linesChanged}</tspan>
  </text>
</g>

<!-- Views -->
<g class="stat-row" style="animation-delay: 600ms" transform="translate(20, 170)">
  <svg class="icon" width="16" height="16" viewBox="0 0 16 16" y="-12">
...
<!-- Repositories -->
<g class="stat-row" style="animation-delay: 750ms" transform="translate(20, 200)">
  <svg class="icon" width="16" height="16" viewBox="0 0 16 16" y="-12">
