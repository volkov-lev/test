...
<!-- Header -->
<text x="30" y="38" class="header">${stats.name}'s GitHub Statistics</text>

<!-- Stars -->
<g class="stat-row" style="animation-delay: 0ms" transform="translate(20, 50)">
  <svg class="icon" width="16" height="16" viewBox="0 0 16 16" x="25" y="53">
  ...
  <text x="50" y="66">
    ...
    <tspan x="300" y="66.5" class="stat-value">${stats.stars}</tspan>
  </text>
</g>
