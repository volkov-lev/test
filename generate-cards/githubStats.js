...
// Цвета для светлой и темной темы, как в languageStats.js
const colors = {
  light: {
    background: "none",
  ...
  async queryRest(endpoint) {
    ...
    do {
      ...
      if (response.status === 202) {
        ...
        throw new Error(
          "Не удалось получить данные из GitHub REST API: " + errorText
        );
      }
...
async function fetchFromGitHub(query, variables = {}) {
  ...
  if (!response.ok) {
    const errorText = await response.text();
    throw new Error("Не удалось получить данные из GitHub API: " + errorText);
  }
...
#gh-dark-mode-only:target .value {
  color: ${colors.dark.textPrimary};
}
  ...
  <g>
    <foreignObject x="21" y="21" width="318" height="168">
      <div xmlns="http://www.w3.org/1999/xhtml">
        <h2>${stats.name}'s GitHub Statistics</h2>
        <ul>
          <li style="animation-delay: 0ms;">
            ...
            <span class="label">Stars:</span><span class="value">${stats.stars}</span>
          </li>
          <li style="animation-delay: 150ms;">
            <svg class="octicon" viewBox="0 0 16 16" width="16" height="16"><path fill-rule="evenodd" d="M5 3.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm0 2.122a2.25 2.25 0 10-1.5 0v.878A2.25 2.25 0 005.75 8.5h1.5v2.128a2.251 2.251 0 101.5 0V8.5h1.5a2.25 2.25 0 002.25-2.25v-.878a2.25 2.25 0 10-1.5 0v.878a.75.75 0 01-.75.75h-4.5A.75.75 0 015 6.25v-.878zm3.75 7.378a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm3-8.75a.75.75 0 100-1.5.75.75 0 000 1.5z"></path></svg>
            <span class="label">Forks:</span><span class="value">${stats.forks}</span>
          </li>
          <li style="animation-delay: 300ms;">
            ...
            <span class="label">All-time contributions:</span><span class="value">${stats.contributions}</span>
          </li>
          <li style="animation-delay: 450ms;">
            <svg class="octicon" viewBox="0 0 16 16" width="16" height="16"><path fill-rule="evenodd" d="M8.75 1.75a.75.75 0 00-1.5 0V5H4a.75.75 0 000 1.5h3.25v3.25a.75.75 0 001.5 0V6.5H12A.75.75 0 0012 5H8.75V1.75zM4 13a.75.75 0 000 1.5h8a.75.75 0 100-1.5H4z"></path></svg>
            <span class="label">Lines of code changed:</span><span class="value">${stats.linesChanged}</span>
          </li>
          <li style="animation-delay: 600ms;">
            ...
            <span class="label">Repository views (past two weeks):</span><span class="value">${stats.views}</span>
          </li>
          <li style="animation-delay: 750ms;">
            <svg class="octicon" viewBox="0 0 16 16" width="16" height="16"><path fill-rule="evenodd" d="M2 2.5A2.5 2.5 0 014.5 0h8.75a.75.75 0 01.75.75v12.5a.75.75 0 01-.75.75h-2.5a.75.75 0 110-1.5h1.75v-2h-8a1 1 0 00-.714 1.7.75.75 0 01-1.072 1.05A2.495 2.495 0 012 11.5v-9zm10.5-1V9h-8c-.356 0-.694.074-1 .208V2.5a1 1 0 011-1h8zM5 12.25v3.25a.25.25 0 00.4.2l1.45-1.087a.25.25 0 01.3 0L8.6 15.7a.25.25 0 00.4-.2v-3.25a.25.25 0 00-.25-.25h-3.5a.25.25 0 00-.25.25z"></path></svg>
            <span class="label">Repositories with contributions:</span><span class="value">${stats.repos}</span>
          </li>
        </ul>
      </div>
    </foreignObject>
